            ...
            $.ajax({
                  ...
                  console.log(data.title)
                    ...
                    if (data.creator == user_id){
                        $(".participants").append("<button class='delete' value='"+ data.id + "'>" + "Удалить событие </button>")
                    }
                    ...
                    if (FLAG) {
                        $(".participants").append("<button class='refuse' value='"+ data.id + "'>" + "Отказаться от участия </button>")
                    } else{
                        $(".participants").append("<button class='agree' value='"+ data.id + "'>" + "Принять участие</button>")
                    }
                  },
                  error: function(er) {
                    console.log(er);
